          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link 
              ...
              className={cn(
                ...
                isActive('/') && !pathname.includes('/movie') && !pathname.includes('/tv') && !pathname.includes('/search') && !pathname.includes('/watchlist') && !pathname.includes('/discover') && !pathname.includes('/person')
                  ? "text-primary" 
